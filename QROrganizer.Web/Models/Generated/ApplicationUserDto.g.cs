...
{
    public partial class ApplicationUserDtoGen : GeneratedDto<QROrganizer.Data.Models.ApplicationUser>
    {
        ...
        /// </summary>
        public override void MapFrom(QROrganizer.Data.Models.ApplicationUser obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
        ...
        /// </summary>
        public override void MapTo(QROrganizer.Data.Models.ApplicationUser entity, IMappingContext context)
        {
            var includes = context.Includes;
